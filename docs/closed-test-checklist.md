...
| # | Item | State | Owner |
|---|---|---|---|
| 1 | **Real launcher icon** (replace default Flutter logo) | ❌ BLOCKER | needs art |
...
| 4 | **≥ 2 phone screenshots** (danger / selected / rescued / complete) | ❌ todo | capture on device |
| 5 | **Feature graphic** 1024×500 | ❌ todo | needs art |
